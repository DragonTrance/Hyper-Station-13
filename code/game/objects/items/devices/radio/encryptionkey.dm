...
/obj/item/encryptionkey/heads/wooo
	name = "stop taking out encryption keys you nerd"
	icon_state = "cap_cypherkey"
	channels = list(RADIO_CHANNEL_CENTCOM = 1, RADIO_CHANNEL_SYNDICATE = 1, RADIO_CHANNEL_COMMAND = 1, RADIO_CHANNEL_SECURITY = 1, RADIO_CHANNEL_ENGINEERING = 1, RADIO_CHANNEL_SCIENCE = 1, RADIO_CHANNEL_MEDICAL = 1, RADIO_CHANNEL_SUPPLY = 1, RADIO_CHANNEL_SERVICE = 1)
