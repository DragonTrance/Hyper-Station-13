		...
		if(!(NOEYES in species_traits))
			...
			if(!has_eyes)
				...
				if(OFFSET_FACE in offset_features)
					left_eye.pixel_x += offset_features[OFFSET_FACE][1]
					left_eye.pixel_y += offset_features[OFFSET_FACE][2]
					right_eye.pixel_x += offset_features[OFFSET_FACE][1]
					right_eye.pixel_y += offset_features[OFFSET_FACE][2]
				standing += left_eye
				standing += right_eye
